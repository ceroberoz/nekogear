...
<html>
    <head>
    	<TITLE>Distro Nekogear Works | Home</TITLE>
		    ...
		    <div class="row">
		    	<nav class="navigation-bar dark">
				    <nav class="navigation-bar-content">
					    ...
					    <item class="element place-right"><a href="<?php echo base_url();?>index.php/login">login</a></item>
	        	...
	        	<?php foreach($details as $row):?>
	        		<div class="tile double">
	        			<div class="tile-content image">
							<a href="<?php base_url();?>detail/<?php echo $row->item_id;?>"><img src="<?php echo base_url();?>assets/images/items/<?php echo $row->image;?>"></a>
						</div>
